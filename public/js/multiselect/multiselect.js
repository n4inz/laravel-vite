jQuery(function() {
    ...
    option.click(function(e) {
      ...
      dropdown.append(function(e) {
        return jQuery('<div class="multiSelect_choice"><span>'+ self.children().text() +'</span><div class="close"><svg class="multiSelect_deselect -iconX"><use href="#iconX"></use></svg></div></div>').click(function(e) {
          var self = jQuery(this);
          e.stopPropagation();
          self.remove();
