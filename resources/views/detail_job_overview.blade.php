    ...
    <article id="article" class="ml-56 space-x-2 mt-[85px] px-10 xl:w-[80%]">
        <div>
            <div class="h-[228px] w-[1016px] xl:w-full bg-bgbody px-6 rounded">
                ...
                <ul class="mt-6 flex flex-wrap font-medium text-center" >
                    <li class="mr-12" >
                        <button class="overview-tab inline-block px-2 border-b border-palet text-palet" >Overview</button>
                    </li>
                    <li class="mr-12" >
                        <button class="overview-tab inline-block px-2 border-b border-transparent  hover:border-palet text-[#AFABAB]" >Task</button>
                    </li>
                    <li class="mr-12" >
                        <button class="overview-tab inline-block px-2 border-b border-transparent  hover:border-palet text-[#AFABAB]" >Talent</button>
                    </li>
                    <li class="mr-12" >
                        <button class="overview-tab inline-block px-2 border-b border-transparent  hover:border-palet text-[#AFABAB]" >Documents</button>
                    </li>
                    <li >
                        <button class="overview-tab inline-block px-2 border-b border-transparent  hover:border-palet text-[#AFABAB]" >Activities</button>
                    </li>
                </ul>
            </div>
            {{-- Tabs Overview --}}
