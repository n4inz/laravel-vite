    ...
    <article id="article" class=" ml-56 space-x-2 mt-[85px] px-10 w-[80%]">
        <div class="h-20 xl:w-full bg-bgbody px-6 flex items-center justify-between rounded">
            <div class="flex items-center">
                ...
                <div class="relative w-80 left-1">
                    ...
                    <input type="text"  class="bg-gray-50 border border-gray-300 text-gray-900 text-xs rounded-lg outline-none  block w-full pl-10 p-2 focus:ring-0" placeholder="Search for tasks, projects, ..." required>
                </div>
            </div>
        ...
        <div class="mt-[42px] w-full  flex space-x-5 overflow-auto overflow-y-hidden mb-20">               
            ...
            <div>
                ...
                <div data-modal-toggle="create-job" class="flex items-center justify-center hover:cursor-pointer w-[265px] h-[42px] bg-[#DAF2F1] mt-3 rounded mb-5">
                    <div class="relative">
