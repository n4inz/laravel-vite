																	...
																	<table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                                        ...
                                                                        <tr mc:hideable>
																			<td class="text" style="background: #3BD7CF; padding: 40px 32px 40px 32px; color:#000000; font-family:'Yantramanav', Arial, sans-serif; font-size:16px; line-height:20px; min-width:auto !important;">
                                                                               <table>
                                                                                    <tr >
                                                                                        <td align="left" style="font-size: 30px; line-height: 36px; font-style: normal; font-weight: 500; color: white;">Hi, N4inz</td>
                                                                                    </tr>
                                                                                    <tr>
                                                                        ...
                                                                        <tr mc:hideable>
																			<td class="text" style="border-bottom: 1px solid #d1d5db; background: white; padding: 5px 32px 20px 32px; color:#000000; font-family:'Yantramanav', Arial, sans-serif; font-size:16px; line-height:20px; min-width:auto !important;">
                                                                               <table width="100%">
                                                                                    <tr>
                                                                                        <td rowspan="2">
                                                                                            {{-- <span style="padding: 13px; border-radius: 99px; background: red; color: white;">ZN</span> --}}
                                                                                            <img style="width:48px; height: 48px; border-radius: 999px;" src="{{ asset('images/family/home2.png') }}" alt="avatar">
                                                                                        </td>
                                                                                        <td align="left" style=" font-size: 20px; line-height: 28px; font-weight: 500; font-style: normal;">Jerome Bell</td>
                                                                                        <td rowspan="2" style="font-size: 12px; line-height: 16px; font-weight: 600; font-style: normal;">
                                                                                            5 Days / Week
                                                                                        </td>
                                                                                        <td rowspan="2" style="font-size: 12px; line-height: 16px; font-weight: 600; font-style: normal;">
                                                                                            $25 / hour
                                                                                    ...
                                                                                    <tr>
                                                                                        <td align="left" style="font-size: 12px; line-height: 16px font-weight: 300; font-style: normal">2464 Royal Ln. Mesa, New Jersey 45463</td>
                                                                                    </tr>
                                                                                    <tr>
																		...
																		<tr mc:hideable>
																			<td class="text" style="border-bottom: 1px solid #d1d5db; background: white; padding: 5px 32px 20px 32px; color:#000000; font-family:'Yantramanav', Arial, sans-serif; font-size:16px; line-height:20px; min-width:auto !important;">
                                                                               <table width="100%">
                                                                                    <tr>
                                                                                        <td rowspan="2">
                                                                                            <img style="width:48px; border-radius: 999px;" src="{{ asset('images/dummy-avatar.png') }}" alt="avatar">
                                                                                        </td>
                                                                                        <td align="left" style=" font-size: 20px; line-height: 28px; font-weight: 500; font-style: normal;">Jerome Bell</td>
                                                                                        <td rowspan="2" style="font-size: 12px; line-height: 16px; font-weight: 600; font-style: normal;">
                                                                                            5 Days / Week
																		...
																		<tr mc:hideable>
																			<td class="text" style="padding: 5px 32px 20px 32px; color:#000000; font-family:'Yantramanav', Arial, sans-serif; font-size:16px; line-height:20px; min-width:auto !important;">
																				<table style="padding-top: 25px;" width="100%">
																					<tr>
																						<td><img style="width: 60px;" src="{{ asset('images/logo/copyright.png') }}" alt=""></td>
																					</tr>
																					<tr>
																						<td>
