                    ...
                    <div class="w-[265px]">
                        ...
                        <div class="w-full flex justify-between">
                            <div class="flex items-center space-x-1">
                                ...
                                <div class="flex items-center justify-center w-6 h-5 border text-[#827C7C] border-[#827C7C] rounded-xl">{{ $potential_clients->count() }}</div>
                            </div>
                            <div>
                        ...
                        @foreach ($potential_clients as $value )
                            <a href="{{ route('jobboard.overview', ['id_unique' => $value->id_unique] )}}">
                                <div class="w-full h-[211px] bg-bgbody mt-3 rounded">
                                    <div class="h-40 px-4">
                                        <div class="flex items-center justify-between pt-[11px]">
                                            <div class="text-xs font-semibold text-[#2CA6A0]">#{{ $value->id_unique }}</div>
                                            <div>
                                                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                    <path d="M6 13.5C6.82843 13.5 7.5 12.8284 7.5 12C7.5 11.1716 6.82843 10.5 6 10.5C5.17157 10.5 4.5 11.1716 4.5 12C4.5 12.8284 5.17157 13.5 6 13.5Z" fill="#827C7C"/>
                                                    <path d="M12 13.5C12.8284 13.5 13.5 12.8284 13.5 12C13.5 11.1716 12.8284 10.5 12 10.5C11.1716 10.5 10.5 11.1716 10.5 12C10.5 12.8284 11.1716 13.5 12 13.5Z" fill="#827C7C"/>
                    ...
                    <div class="w-[265px]">
                        ...
                        <div class="w-full flex justify-between">
                            <div class="flex items-center space-x-1">
                                ...
                                <div class="flex items-center justify-center w-6 h-5 border text-[#827C7C] border-[#827C7C] rounded-xl">{{ $interviewing->count() }}</div>
                            </div>
                            <div>
                                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <path d="M6 13.5C6.82843 13.5 7.5 12.8284 7.5 12C7.5 11.1716 6.82843 10.5 6 10.5C5.17157 10.5 4.5 11.1716 4.5 12C4.5 12.8284 5.17157 13.5 6 13.5Z" fill="#827C7C"/>
                    ...
                    <div class="w-[265px]">
                        ...
                        <div class="w-full  flex justify-between">
                            <div class="flex items-center space-x-1">
                                ...
                                <div class="flex items-center justify-center w-6 h-5 border text-[#827C7C] border-[#827C7C] rounded-xl">{{ $trialing->count() }}</div>
                            </div>
                            <div>
                                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <path d="M6 13.5C6.82843 13.5 7.5 12.8284 7.5 12C7.5 11.1716 6.82843 10.5 6 10.5C5.17157 10.5 4.5 11.1716 4.5 12C4.5 12.8284 5.17157 13.5 6 13.5Z" fill="#827C7C"/>
                    ...
                    <div class="w-[265px]">
                        ...
                        <div class="w-full flex justify-between">
                            <div class="flex items-center space-x-1">
                                ...
                                <div class="flex items-center justify-center w-6 h-5 border text-[#827C7C] border-[#827C7C] rounded-xl">{{ $completed->count() }}</div>
                            </div>
                            <div>
                                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <path d="M6 13.5C6.82843 13.5 7.5 12.8284 7.5 12C7.5 11.1716 6.82843 10.5 6 10.5C5.17157 10.5 4.5 11.1716 4.5 12C4.5 12.8284 5.17157 13.5 6 13.5Z" fill="#827C7C"/>
