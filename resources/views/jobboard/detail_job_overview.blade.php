                                    ...
                                    <div class="px-4 mt-6">
                                        ...
                                        <div class="flex w-full py-4 px-5 space-x-8">
                                            ...
                                            <div class="flex flex-col items-center  space-y-2">
                                                ...
                                                <div class="{{ $values->assist_bathing ? 'overview-responsibilities-title' : 'overview-responsibilities-title-muted' }} max-w-[70px]">Assist Bathing</div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="flex item-center  w-full py-4 px-5 space-x-8">
                                            <div class="flex flex-col items-center  space-y-2">
                                                <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                    <path fill="{{ $values->nanny ? '#FA9D6B' : '#DDDDDD' }}" d="M13.9286 12.8571H20V1.07143C20 0.477679 19.5223 0 18.9286 0H1.07143C0.477679 0 0 0.477679 0 1.07143V18.9286C0 19.5223 0.477679 20 1.07143 20H12.8571V13.9286C12.8571 13.3393 13.3393 12.8571 13.9286 12.8571ZM19.6875 15.3125L15.3125 19.6875C15.1116 19.8884 14.8393 20 14.5536 20H14.2857V14.2857H20V14.558C20 14.8393 19.8884 15.1116 19.6875 15.3125Z" />
                                                </svg>
                                                <div class="{{ $values->nanny ? 'overview-responsibilities-title' : 'overview-responsibilities-title-muted' }} max-w-[70px]">Nanny</div>
                                            </div>
            
                                            <div class="flex flex-col items-center  space-y-2">
                                                <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                    <path fill="{{ $values->sister ? '#FA9D6B' : '#DDDDDD' }}" d="M13.9286 12.8571H20V1.07143C20 0.477679 19.5223 0 18.9286 0H1.07143C0.477679 0 0 0.477679 0 1.07143V18.9286C0 19.5223 0.477679 20 1.07143 20H12.8571V13.9286C12.8571 13.3393 13.3393 12.8571 13.9286 12.8571ZM19.6875 15.3125L15.3125 19.6875C15.1116 19.8884 14.8393 20 14.5536 20H14.2857V14.2857H20V14.558C20 14.8393 19.8884 15.1116 19.6875 15.3125Z" />
                                                </svg>
                                                <div class="{{ $values->sister ? 'overview-responsibilities-title' : 'overview-responsibilities-title-muted' }} max-w-[70px]">Sister</div>
                                            </div>
            
                                            <div class="flex flex-col items-center  space-y-2">
                                                <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                    <path fill="{{ $values->maternity_care ? '#FA9D6B' : '#DDDDDD' }}" d="M13.9286 12.8571H20V1.07143C20 0.477679 19.5223 0 18.9286 0H1.07143C0.477679 0 0 0.477679 0 1.07143V18.9286C0 19.5223 0.477679 20 1.07143 20H12.8571V13.9286C12.8571 13.3393 13.3393 12.8571 13.9286 12.8571ZM19.6875 15.3125L15.3125 19.6875C15.1116 19.8884 14.8393 20 14.5536 20H14.2857V14.2857H20V14.558C20 14.8393 19.8884 15.1116 19.6875 15.3125Z" />
                                                </svg>
                                                <div class="{{ $values->maternity_care ? 'overview-responsibilities-title' : 'overview-responsibilities-title-muted' }} max-w-[70px]">Maternity Care</div>
                                            </div>
            
                                            <div class="flex flex-col items-center  space-y-2">
                                                <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                    <path fill="{{ $values->at_home_daycare ? '#FA9D6B' : '#DDDDDD' }}" d="M13.9286 12.8571H20V1.07143C20 0.477679 19.5223 0 18.9286 0H1.07143C0.477679 0 0 0.477679 0 1.07143V18.9286C0 19.5223 0.477679 20 1.07143 20H12.8571V13.9286C12.8571 13.3393 13.3393 12.8571 13.9286 12.8571ZM19.6875 15.3125L15.3125 19.6875C15.1116 19.8884 14.8393 20 14.5536 20H14.2857V14.2857H20V14.558C20 14.8393 19.8884 15.1116 19.6875 15.3125Z" />
                                                </svg>
                                                <div class="{{ $values->at_home_daycare ? 'overview-responsibilities-title' : 'overview-responsibilities-title-muted' }} max-w-[70px]">At Home Daycare</div>
                                            </div>
                                            <div class="flex flex-col items-center  space-y-2">
                                                <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                    <path fill="{{ $values->infant ? '#FA9D6B' : '#DDDDDD' }}" d="M13.9286 12.8571H20V1.07143C20 0.477679 19.5223 0 18.9286 0H1.07143C0.477679 0 0 0.477679 0 1.07143V18.9286C0 19.5223 0.477679 20 1.07143 20H12.8571V13.9286C12.8571 13.3393 13.3393 12.8571 13.9286 12.8571ZM19.6875 15.3125L15.3125 19.6875C15.1116 19.8884 14.8393 20 14.5536 20H14.2857V14.2857H20V14.558C20 14.8393 19.8884 15.1116 19.6875 15.3125Z" />
                                                </svg>
                                                <div class="{{ $values->infant ? 'overview-responsibilities-title' : 'overview-responsibilities-title-muted' }} overview-responsibilities-title max-w-[70px]">Infant</div>
                                            </div>
                                            <div class="flex flex-col items-center  space-y-2">
                                                <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                    <path fill="{{ $values->young_baby ? '#FA9D6B' : '#DDDDDD' }}" d="M13.9286 12.8571H20V1.07143C20 0.477679 19.5223 0 18.9286 0H1.07143C0.477679 0 0 0.477679 0 1.07143V18.9286C0 19.5223 0.477679 20 1.07143 20H12.8571V13.9286C12.8571 13.3393 13.3393 12.8571 13.9286 12.8571ZM19.6875 15.3125L15.3125 19.6875C15.1116 19.8884 14.8393 20 14.5536 20H14.2857V14.2857H20V14.558C20 14.8393 19.8884 15.1116 19.6875 15.3125Z" />
                                                </svg>
                                                <div class="{{ $values->young_baby ? 'overview-responsibilities-title' : 'overview-responsibilities-title-muted' }} max-w-[70px]">Young Baby</div>
                                            </div>
                                        </div>
                                        <div class="flex item-center  w-full py-4 px-5 space-x-8">
                                            <div class="flex flex-col items-center  space-y-2">
                                                <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                    <path fill="{{ $values->toddler ? '#FA9D6B' : '#DDDDDD' }}" d="M13.9286 12.8571H20V1.07143C20 0.477679 19.5223 0 18.9286 0H1.07143C0.477679 0 0 0.477679 0 1.07143V18.9286C0 19.5223 0.477679 20 1.07143 20H12.8571V13.9286C12.8571 13.3393 13.3393 12.8571 13.9286 12.8571ZM19.6875 15.3125L15.3125 19.6875C15.1116 19.8884 14.8393 20 14.5536 20H14.2857V14.2857H20V14.558C20 14.8393 19.8884 15.1116 19.6875 15.3125Z" />
                                                </svg>
                                                <div class="{{ $values->toddler ? 'overview-responsibilities-title' : 'overview-responsibilities-title-muted' }} max-w-[70px]">Toddler</div>
                                            </div>
                                            <div class="flex flex-col items-center  space-y-2">
                                                <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                    <path fill="{{ $values->press_schooler ? '#FA9D6B' : '#DDDDDD' }}" d="M13.9286 12.8571H20V1.07143C20 0.477679 19.5223 0 18.9286 0H1.07143C0.477679 0 0 0.477679 0 1.07143V18.9286C0 19.5223 0.477679 20 1.07143 20H12.8571V13.9286C12.8571 13.3393 13.3393 12.8571 13.9286 12.8571ZM19.6875 15.3125L15.3125 19.6875C15.1116 19.8884 14.8393 20 14.5536 20H14.2857V14.2857H20V14.558C20 14.8393 19.8884 15.1116 19.6875 15.3125Z" />
                                                </svg>
                                                <div class="{{ $values->press_schooler ? 'overview-responsibilities-title' : 'overview-responsibilities-title-muted' }} max-w-[70px]">Press Schooler</div>
                                            </div>
            
                                            <div class="flex flex-col items-center  space-y-2">
                                                <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                    <path fill="{{ $values->grade_Schooler ? '#FA9D6B' : '#DDDDDD' }}" d="M13.9286 12.8571H20V1.07143C20 0.477679 19.5223 0 18.9286 0H1.07143C0.477679 0 0 0.477679 0 1.07143V18.9286C0 19.5223 0.477679 20 1.07143 20H12.8571V13.9286C12.8571 13.3393 13.3393 12.8571 13.9286 12.8571ZM19.6875 15.3125L15.3125 19.6875C15.1116 19.8884 14.8393 20 14.5536 20H14.2857V14.2857H20V14.558C20 14.8393 19.8884 15.1116 19.6875 15.3125Z" />
                                                </svg>
                                                <div class="{{ $values->grade_Schooler ? 'overview-responsibilities-title' : 'overview-responsibilities-title-muted' }} max-w-[70px]">Grade Schooler</div>
                                            </div>
                                        </div>
                                        @endforeach
                                    </div>
