                                    ...
                                    <div class="flex space-x-2 mt-6">
                                        ...
                                        <div class="w-full">
                                            ...
                                            <div class="add_reply{{ $val->id }}">
                                                {{-- <div class="reply_text${id} px-4 mt-4">
                                                    <div class="w-full rounded-md text-xs ">
                                                        <textarea id="reply_comment{{ $val->id }}" rows="2" class="block p-2.5 w-full text-sm text-colortext bg-[#F7F7F7] rounded  border-none outline-none focus:ring-0" placeholder="Enter a comments"></textarea>
                                                    </div>
                                                </div>
                                                <div class="btn_reply{{ $val->id }} flex justify-end px-4 mt-2">
                                                    <button class="submit w-20 h-7 bg-palet rounded-md ">
