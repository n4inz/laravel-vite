                                ...
                                <div class="bg-bgbody rounded ">
                                    ...
                                    <div class="px-4 mt-8 flex space-x-4">
                                        <div>
                                            ...
                                            <div class="flex items-center justify-center w-[316px] h-10 border border-[#ECECEC] rounded text-[#222222]">
                                                <input name="first_name" value="{{ old('first_name') }}" type="text" id="first-name" class="overview-modal-add-talent-text  border-none focus:ring-0 w-full p-1 ml-3 outline-none " placeholder="">
                                            </div>
                                        </div>
                                        <div>
                                            <label for="last-name" class="block overview-status-field text-[#222222] mb-2">Last Name</label>
                                            <div class="flex items-center justify-center w-[316px] h-10 border border-[#ECECEC] rounded text-[#222222]">
                                                <input name="last_name" value="{{ old('last_name') }}" type="text" id="last-name" class="overview-modal-add-talent-text  border-none focus:ring-0 w-full p-1 ml-3 outline-none " placeholder="">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="px-4 mt-4 flex space-x-4">
                                        <div>
                                            ...
                                            <div class="flex items-center justify-center w-[316px] h-10 border border-[#ECECEC] rounded text-[#222222]">
                                                <input name="email" value="{{ old('email') }}" type="text" id="email" class="overview-modal-add-talent-text  border-none focus:ring-0 w-full p-1 ml-3 outline-none " placeholder="">
                                            </div>
                                        </div>
                                        <div>
                                            <label for="phone" class="block overview-status-field text-[#222222] mb-2">Phone</label>
                                            <div class="flex items-center justify-center w-[316px] h-10 border border-[#ECECEC] rounded text-[#222222]">
                                                <input name="phone" value="{{ old('phone') }}" type="text" id="phone" class="overview-modal-add-talent-text  border-none focus:ring-0 w-full p-1 ml-3 outline-none " placeholder="">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="px-4 mt-4 flex space-x-4">
                                    ...
                                    <div class="px-4 mt-4 ">
                                        ...
                                        <div class="w-[650px] h-[221px] flex items-center justify-center border border-[#CCD3DC] mt-2 rounded relative">
                                            <textarea id="message" name="note" rows="9" class="overview-modal-add-talent-text  border-none focus:ring-0 w-full p-1 ml-3 outline-none text-[#222222]" placeholder="">{{ old('note') }}</textarea>
